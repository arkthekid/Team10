  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 max-w-lg mx-auto w-full p-4 md:p-6">
        <h2 className="text-2xl font-bold text-foreground mb-6">Create New Listing</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Input id="price" type="number" min="0" value={price} onChange={(e) => setPrice(e.target.value)} placeholder="Leave empty for free" />
          </div>
          <div>
            ...
            <div className="flex flex-wrap gap-3 mt-2">
              {images.map((src, i) => (
                <div key={i} className="relative w-20 h-20 rounded-md overflow-hidden border border-border">
                  ...
                  <button type="button" onClick={() => removeImage(i)} className="absolute top-0.5 right-0.5 bg-background/80 rounded-full p-0.5">
